...
Предложи достопримечательности, кафе и местные активности. Пиши кратко и дружелюбно. Нужна подробная информация о каждом месте для посещения ее стоимости и маршрут`, req.City)
